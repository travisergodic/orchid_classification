...
def train(): 
    ...
    # dataset
    train_dataset = FlowerDataset('./training/', df_train_label, class_num, build_train_transform)
    test_dataset = FlowerDataset('./training/', df_test_label, class_num, build_test_transform)
